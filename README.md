...
The usage of attributes to generate the glance-api.conf is described in the openstack-common cookbook.
...
- Upload image to glance. If you want to upload image during openstack
  ...
  in a certain role and ensure before this recipe or the os-image role glance api recipes have been executed.
